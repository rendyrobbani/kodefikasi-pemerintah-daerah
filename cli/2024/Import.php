...
$reference = "kodefikasi_pemda_2023";
...
for ($i = 0; $i < 8; $i++) {
	...
	switch ($i) {
		case 0:
			...
			$service->deleteFromExcelFiles(Peraturan::KEPMENDAGRI_TAHUN_2024_NOMOR_900_1_15_5_3406, array_values(array_filter($excel_files, fn($excel_file) => str_starts_with(pathinfo($excel_file, PATHINFO_FILENAME), "B-DELETE"))));
//			$service->updateFromExcelFiles(Peraturan::KEPMENDAGRI_TAHUN_2024_NOMOR_900_1_15_5_3406, array_values(array_filter($excel_files, fn($excel_file) => str_starts_with(pathinfo($excel_file, PATHINFO_FILENAME), "B-UPDATE"))), false);
			break;
		case 1:
			$service = Application::getComponent(UrusanKabupatenService::class);
			$service->deleteFromExcelFiles(Peraturan::KEPMENDAGRI_TAHUN_2024_NOMOR_900_1_15_5_3406, array_values(array_filter($excel_files, fn($excel_file) => str_starts_with(pathinfo($excel_file, PATHINFO_FILENAME), "C-DELETE"))));
			$service->updateFromExcelFiles(Peraturan::KEPMENDAGRI_TAHUN_2024_NOMOR_900_1_15_5_3406, array_values(array_filter($excel_files, fn($excel_file) => str_starts_with(pathinfo($excel_file, PATHINFO_FILENAME), "C-UPDATE"))), false);
			break;
		case 2:
			$service = Application::getComponent(FungsiProvinsiService::class);
			$service->deleteFromExcelFiles(Peraturan::KEPMENDAGRI_TAHUN_2024_NOMOR_900_1_15_5_3406, array_values(array_filter($excel_files, fn($excel_file) => str_starts_with(pathinfo($excel_file, PATHINFO_FILENAME), "D-DELETE"))));
			$service->updateFromExcelFiles(Peraturan::KEPMENDAGRI_TAHUN_2024_NOMOR_900_1_15_5_3406, array_values(array_filter($excel_files, fn($excel_file) => str_starts_with(pathinfo($excel_file, PATHINFO_FILENAME), "D-UPDATE"))), false);
			break;
		case 3:
			$service = Application::getComponent(FungsiKabupatenService::class);
			$service->deleteFromExcelFiles(Peraturan::KEPMENDAGRI_TAHUN_2024_NOMOR_900_1_15_5_3406, array_values(array_filter($excel_files, fn($excel_file) => str_starts_with(pathinfo($excel_file, PATHINFO_FILENAME), "E-DELETE"))));
			$service->updateFromExcelFiles(Peraturan::KEPMENDAGRI_TAHUN_2024_NOMOR_900_1_15_5_3406, array_values(array_filter($excel_files, fn($excel_file) => str_starts_with(pathinfo($excel_file, PATHINFO_FILENAME), "E-UPDATE"))), false);
			break;
		case 4:
			$service = Application::getComponent(SumberService::class);
			$service->deleteFromExcelFiles(Peraturan::KEPMENDAGRI_TAHUN_2024_NOMOR_900_1_15_5_3406, array_values(array_filter($excel_files, fn($excel_file) => str_starts_with(pathinfo($excel_file, PATHINFO_FILENAME), "H-DELETE"))));
			$service->updateFromExcelFiles(Peraturan::KEPMENDAGRI_TAHUN_2024_NOMOR_900_1_15_5_3406, array_values(array_filter($excel_files, fn($excel_file) => str_starts_with(pathinfo($excel_file, PATHINFO_FILENAME), "H-UPDATE"))), false);
			break;
		case 5:
			$service = Application::getComponent(NeracaService::class);
			$service->deleteFromExcelFiles(Peraturan::KEPMENDAGRI_TAHUN_2024_NOMOR_900_1_15_5_3406, array_values(array_filter($excel_files, fn($excel_file) => str_starts_with(pathinfo($excel_file, PATHINFO_FILENAME), "I-DELETE"))));
			$service->updateFromExcelFiles(Peraturan::KEPMENDAGRI_TAHUN_2024_NOMOR_900_1_15_5_3406, array_values(array_filter($excel_files, fn($excel_file) => str_starts_with(pathinfo($excel_file, PATHINFO_FILENAME), "I-UPDATE"))), false);
			break;
		case 6:
			$service = Application::getComponent(LraService::class);
			$service->deleteFromExcelFiles(Peraturan::KEPMENDAGRI_TAHUN_2024_NOMOR_900_1_15_5_3406, array_values(array_filter($excel_files, fn($excel_file) => str_starts_with(pathinfo($excel_file, PATHINFO_FILENAME), "J-DELETE"))));
			$service->updateFromExcelFiles(Peraturan::KEPMENDAGRI_TAHUN_2024_NOMOR_900_1_15_5_3406, array_values(array_filter($excel_files, fn($excel_file) => str_starts_with(pathinfo($excel_file, PATHINFO_FILENAME), "J-UPDATE"))), false);
			break;
		case 7:
			$service = Application::getComponent(LoService::class);
			$service->deleteFromExcelFiles(Peraturan::KEPMENDAGRI_TAHUN_2024_NOMOR_900_1_15_5_3406, array_values(array_filter($excel_files, fn($excel_file) => str_starts_with(pathinfo($excel_file, PATHINFO_FILENAME), "K-DELETE"))));
			$service->updateFromExcelFiles(Peraturan::KEPMENDAGRI_TAHUN_2024_NOMOR_900_1_15_5_3406, array_values(array_filter($excel_files, fn($excel_file) => str_starts_with(pathinfo($excel_file, PATHINFO_FILENAME), "K-UPDATE"))), false);
			break;
	}
