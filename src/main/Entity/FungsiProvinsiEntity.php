...
class FungsiProvinsiEntity
{
	...
	public function isEqual(FungsiProvinsiEntity|null $entity): bool
	{
	...
	public function log(): FungsiProvinsiLogEntity
	{
		$logEntity = new FungsiProvinsiLogEntity();
