...
#[Checks([
	...
	new Check("nomor_rekening1 is null or nomor_rekening1 between 1 and 2"),
...
class SumberEntity
{
	...
	public function isEqual(SumberEntity|null $entity): bool
	{
	...
	public function log(): SumberLogEntity
	{
		$logEntity = new SumberLogEntity();
	...
	public function kodeRekening3(Peraturan $peraturan): string|null
	{
		if ($this->nomorRekening3 === null) return null;
		return str_pad($this->nomorRekening3, match ($peraturan) {
			...
			Peraturan::KEPMENDAGRI_TAHUN_2023_NOMOR_900_1_15_5_1317 => 1,
			Peraturan::KEPMENDAGRI_TAHUN_2024_NOMOR_900_1_15_5_3406,
			Peraturan::KEPMENDAGRI_TAHUN_2025_NOMOR_900_1_2850,
			Peraturan::KEPMENDAGRI_TAHUN_2026_NOMOR_900_1_861 => 2,
		}, "0", STR_PAD_LEFT);
	}
	...
	public function kodeRekening6(Peraturan $peraturan): string|null
	{
		...
		return str_pad($this->nomorRekening6, match ($peraturan) {
			...
			Peraturan::KEPMENDAGRI_TAHUN_2020_NOMOR_050_3708,
			Peraturan::KEPMENDAGRI_TAHUN_2021_NOMOR_050_5889,
			Peraturan::KEPMENDAGRI_TAHUN_2023_NOMOR_900_1_15_5_1317 => 2,
			Peraturan::KEPMENDAGRI_TAHUN_2024_NOMOR_900_1_15_5_3406,
	...
	public function kode(Peraturan $peraturan): string|null
	{
		...
		for ($level = 1; $level <= 6; $level++) {
			$value = match ($level) {
				...
				3 => $this->kodeRekening3($peraturan),
