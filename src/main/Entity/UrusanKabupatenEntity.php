...
class UrusanKabupatenEntity
{
	...
	public function isEqual(UrusanKabupatenEntity|null $entity): bool
	{
	...
	public function log(): UrusanKabupatenLogEntity
	{
		$logEntity = new UrusanKabupatenLogEntity();
