...
class UrusanProvinsiServiceImpl extends AbstractUrusanService implements UrusanProvinsiService
{
	public function __construct(Connection                  $connection,
	                            UrusanProvinsiRepository    $repository,
	                            UrusanProvinsiLogRepository $logRepository)
	{
