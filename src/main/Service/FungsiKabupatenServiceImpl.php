...
class FungsiKabupatenServiceImpl implements FungsiKabupatenService
{
	public function __construct(protected Connection                   $connection,
	                            protected FungsiKabupatenRepository    $repository,
	                            protected FungsiKabupatenLogRepository $logRepository)
	{
	}
	...
	function fromExcelFiles(Peraturan $peraturan, array $excel_files, bool $is_perubahan): void
	{
		try {
			...
			/** @var array<string, FungsiKabupatenEntity> $intoEntities */
			$intoEntities = [];
			...
			foreach ($excel_files as $excel_file) {
				...
				foreach ($spreadsheet->getWorksheetIterator() as $worksheet) {
					foreach ($worksheet->getRowIterator() as $row) {
						...
						$intoEntity = new FungsiKabupatenEntity();
	...
	private function handlePermendagriTahun2019(Row $row, string $excel_file, FungsiKabupatenEntity $entity): void
	{
	}

	private function handleKepmendagriTahun2020(Row $row, string $excel_file, FungsiKabupatenEntity $entity): void
	{
	...
	private function handleKepmendagriTahun2021(Row $row, string $excel_file, FungsiKabupatenEntity $entity): void
	{
	}

	private function handleKepmendagriTahun2023(Row $row, string $excel_file, FungsiKabupatenEntity $entity): void
	{
	}

	private function handleKepmendagriTahun2024(Row $row, string $excel_file, FungsiKabupatenEntity $entity): void
	{
	}

	private function handleKepmendagriTahun2025(Row $row, string $excel_file, FungsiKabupatenEntity $entity): void
	{
	}

	private function handleKepmendagriTahun2026(Row $row, string $excel_file, FungsiKabupatenEntity $entity): void
	{
	}
}